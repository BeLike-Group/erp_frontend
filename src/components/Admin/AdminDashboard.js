    ...
    <div className="relative h-[100vh] bg-white">
      {Admin ? (
        <div className="grid grid-cols-6 h-full">
          <div
            className={`   md:block col-span-1 ${Showmenu ? " " : "  "
            ...
            >
              ...
              <li className="mt-4">
                <h5
                  ...
                  className={`cursor-pointer ${activeComponent === "AdminProfile"
              ...
              <li className="mt-4">
                <h5
                  ...
                  className={`cursor-pointer ${activeComponent === "AdminAddTeacher"
                      ? " border-b-2 border-white"
                      : ""
                    }`}
                >
              ...
              <li className="mt-4">
                <h5
                  ...
                  className={`cursor-pointer ${activeComponent === "AdminAddStudent"
                      ? " border-b-2 border-white"
                      : ""
                    }`}
                >
              ...
              <li className="mt-4">
                <h5
                  ...
                  className={` cursor-pointer ${activeComponent === "AddCourse"
                      ? " border-b-2 border-white"
                      : ""
                    }`}
                >
              ...
              <li className="mt-4">
                <h5
                  ...
                  className={` cursor-pointer ${activeComponent === "AdminAddGrade"
                      ? " border-b-2 border-white"
                      : ""
                    }`}
                >
              ...
              <li className="mt-4">
                <h5
                  ...
                  className={`cursor-pointer ${activeComponent === "Admissions"
                      ? " border-b-2 border-white"
                      : ""
                    }`}
                >
