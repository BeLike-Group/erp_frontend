...
export const AdminAddStudent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { studentAvatar, studentIdCardCopy, studentName, studentEmail, studentPassword, studentId, studentIdCardNumber, studentFee } = formData;
    const data = {
      studentName,
      studentEmail,
      studentPassword,
    ...
    try {
      setLoading(true);
      const url = editingStudent ? `/api/v1/admin/update-student/${editingStudent._id}` : `/api/v1/admin/add-student/${selectedGrades}`;
      ...
      const studentsResponse = await axios.get("/api/v1/admin/load-all-students");
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4 relative">
            ...
            <input
              ...
              name="studentPassword" id="studentPassword" value={formData.studentPassword} onChange={handleInputChange} className="text-black mt-1 block w-full p-2 border border-gray-300 rounded-md" />
            <div
          ...
          <div className="mb-4">
            <label htmlFor="studentFee" className="block text-sm font-medium text-gray-700">Student Fee</label>
            <input type="number" name="studentFee" id="studentFee" value={formData.studentFee} onChange={handleInputChange} className="text-black mt-1 block w-full p-2 border border-gray-300 rounded-md" />
          </div>
