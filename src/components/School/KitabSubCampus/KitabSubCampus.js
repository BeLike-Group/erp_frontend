...
import schoolportallogo6 from "../../../Assets/Img/s2.webp"; // Replace with your actual school portal logo pathafaq.jpeg
...
// import "./KitabSubCampus.css"

const KitabSubCampus = () => {
  const schools = [
    
    {
      name: "Kitab Schools Campus 1 Iqbal Campus Millat Town",
      logo: schoolportallogo6, // Replace with your actual school logo path
      link: "/admin-login", // Replace with the actual login link
    },
    {
        name: "Kitab Schools Campus 2 Qasim Campus Kahana Nau",
        logo: schoolportallogo6, // Replace with your actual school logo path
        link: "/admin-login", // Replace with the actual login link
      },
      {
        name: "Kitab Schools Campus 3 Pakistan Star Campus Gajjumtta",
        logo: schoolportallogo6, // Replace with your actual school logo path
        link: "/admin-login", // Replace with the actual login link
      },
      {
        name: "Kitab Schools Campus 4 Punju Campus",
        logo: schoolportallogo6, // Replace with your actual school logo path
        link: "/admin-login", // Replace with the actual login link
      },
