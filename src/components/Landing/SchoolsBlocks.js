...
import schoolportallogo13 from "../../Assets/Img/brook.jpg"; // Replace with your actual school portal logo pathafaq.jpeg
...
const SchoolBlocks = () => {
  const schools = [
    ...
    {
      name: "Kitab School System",
      logo: schoolportallogo2, // Replace with your actual school logo path
      link: "/kss-sub-campus", // Replace with the actual login link
    },
    ...
    {
      name: "The Brooks School System",
      logo: schoolportallogo13, // Replace with your actual school logo path
      link: "/admin-login", // Replace with the actual login link
    },
    {
      name: "Elite High School",
      logo: schoolportallogo14, // Replace with your actual school logo path
      link: "/admin-login", // Replace with the actual login link
    },
    {
      name: "Alpha Educator's School System",
      logo: schoolportallogo15, // Replace with your actual school logo path
      link: "/admin-login", // Replace with the actual login link
    },
    {
      name: "Pre-Forces Boys/Girls School",
