...
import Logo from "../Assets/Medical/medical/l1.png";
...
const MedicalPortal = () => {
  ...
  return (
    <div className="p-8 bg-gradient-to-r from-blue-500 via-green-500 to-blue-600">
      <div className="mb-4 d-flex justify-content-between align-items-center">
        <img
            alt="Logo"
            className="medical-logo ms-lg-2"
           src={Logo}
            style={{ height: "96px", width: "96px" }} // Adjust as needed
          />
