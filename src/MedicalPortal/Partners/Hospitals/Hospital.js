...
const Hospital = () => {
    const hospitals = [
        ...
        {
            name: "Lahore Hospital", // Corrected spelling of 'Lahore'
            logo: hospital2,
            email: "info@lahorehospital.com", // Changed email for clarity
            contact: "+923045678910",
    ...
    return (
        <div className="  pl-52 pr-52 pb-32 bg-gradient-to-r from-blue-500 via-green-500 to-blue-600  ">
            <div className="flex items-center justify-center gap-2.5 mb-10">
                {/* <h1 className="text-2xl font-bold">Belike Edu. Software</h1>
                <img src={Logo} alt="Belike Edu. Logo" className="w-16 h-16"/> */}
                            <h1 className="mt-20  text-3xl font-bold text-center">Our Partner Hospitals</h1>
