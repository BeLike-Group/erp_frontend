        ...
        <div className="p-5 bg-white rounded-lg shadow-lg">
          <div className="flex flex-col items-center md:flex-row md:items-start">
            <div className="flex-shrink-0">
              <img 
                src="http://localhost:3000/static/media/hospital1.f3c5641cb6eae3778723.png"
                alt="Hospital Logo" 
            ...
            <div className="flex flex-col items-center text-center md:items-start md:ml-8 md:text-left">
              <h1 className="text-2xl font-semibold text-black">Doctor's Hospital</h1>
              <p className="mt-2 text-lg text-black">Johar Town, Lahore</p>
